/*
Salesforce.com AJAX Connector 46.0
...
sforce.internal.Debug = function() {
    ...
    this.println = function(s, type) {
        ...
        if (this.win === null || !this.win.document) {
            this.output = null;
            this.win = window.open((typeof window.UserContext != "undefined") ? UserContext.getUrl('/soap/ajax/46.0/debugshell.html') : '/soap/ajax/46.0/debugshell.html', '',
...
sforce.Transport = function(url) {
    ...
    this.send = function (envelope, callback, async, timeout) {
        ...
        if (async) {
            ...
            if(typeof(this.connection.upload) === 'undefined'){
                this.connection.addEventListener( 'progress', function(evt){callback.httpCallback(evt,'progress')},false);
            }else{
                this.connection.upload.addEventListener( 'progress',function(evt){callback.httpCallback(evt,'progress')}, false );
            }
        }
...
sforce.SoapTransport.prototype.httpCallback = function(response, success) {
    try {
        if(success === 'progress'){
            if (this.connectionCallback.onProgress) {
                this.connectionCallback.onProgress(response, this.connectionCallback.source);
            }
        }
...
sforce.Connection = function() {
    ...
    this.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("/services/Soap/u/46.0") : "/services/Soap/u/46.0";
};
    ...
    if (callback) {
        if (typeof(callback) == "function") {
            ...
            if (!callback.onProgress) {
                throw "onProgress not defined in the callback";
            }
        }
    }
...
sforce.connection.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("/services/Soap/u/46.0") : "/services/Soap/u/46.0";
